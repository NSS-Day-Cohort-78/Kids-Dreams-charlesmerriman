...
export const getChildren = () => { const children = structuredClone(database.children); return children }
export const getCelebrities = () => { const celebrities = structuredClone(database.celebrities); return celebrities }